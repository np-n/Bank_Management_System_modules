...
def display_withdraw(event=""):
    user_info1=Label(window1,text="Withdrawn perform succesfully,current data is").place(x=500,y=100)
    Name = Label(window1, text="Name : ").place(x=500, y=150)
    Name_display = Label(window1, text=holder_name).place(x=700, y=150)
    Account_display=Label(window1,text="Account number :").place(x=500,y=150)
    Account_no_display = Label(window1,text=account_num).place(x=700, y=250)
    ...
    Amount_after_withdraw = Label(window1, text=p).place(x=700, y=230)
...
def display_content(event=""):
    ...
    withdraw_message=Label(window1, text="Amount to withdraw").place(x=30, y=550)
    global k
    global withdraw_amt
    k=IntVar()
    ...
    withdraw_button=Button(window1,text="Withdraw",command=display_withdraw).place(x=300,y=600)
