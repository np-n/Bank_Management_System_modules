...
time_label=Label(window1,text="Local Time",font=("Verdana Bold",20),bg="#C0C0C0").place(x=1070,y=2)
time1 = ''
clock = Label(window1, font=('times', 20, 'bold'), bg="#C0C0C0",fg='blue')
clock.pack(padx=2,pady=5,anchor=E)
def tick():
    global time1
